// src/routes/tradingview_unified_output.ts
...
export async function registerTradingViewUnifiedOutput(app: FastifyInstance) {
  // -------------------------------------------------------
  // /tradingview/unified-output
  // -------------------------------------------------------
  app.post("/tradingview/unified-output", async (req, reply) => {
