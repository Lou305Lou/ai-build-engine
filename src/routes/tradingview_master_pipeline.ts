// src/routes/tradingview_master_pipeline.ts
...
export async function registerTradingViewMasterPipeline(app: FastifyInstance) {
  // -------------------------------------------------------
  // /tradingview/master-pipeline
  // -------------------------------------------------------
  app.post("/tradingview/master-pipeline", async (req, reply) => {
    ...
    // -------------------------
    return reply.send({
      status: "master-pipeline-processed",
